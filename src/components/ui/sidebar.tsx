        ...
        <div
          className={cn(
            ...
            collapsible === "icon" && !open ? "w-[--sidebar-width-icon]" : "w-[--sidebar-width]",
             ...
             variant === "floating" && collapsible === 'icon' && !open && "w-[calc(var(--sidebar-width-icon))]",
             variant === "floating" && collapsible === 'icon' && open && "w-[calc(var(--sidebar-width))]",
...
>(({ className, onClick, ...props }, ref) => {
  ...
  const Icon = isMobile ? PanelLeft : open ? PanelLeftClose : PanelLeftOpen;
